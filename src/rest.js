...
module.exports = class Rest {
  ...
  async getxboxProfileBatch(xuids) {
    const response = await this.post('https://peoplehub.xboxlive.com/users/me/people/batch/decoration/detail,preferredcolor', { data: { xuids }, contractVersion: 5 }).then(e => e.people).catch(() => []);
    return response;
  }
